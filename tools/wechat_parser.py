#!/usr/bin/env python3
"""Parse WeChat exports in txt/html/csv form and extract target lines."""
...
def normalize_lines(raw: str, suffix: str) -> list[str]:
    if suffix == ".html":
...
def main() -> int:
    ...
    lines = normalize_lines(raw, path.suffix.lower())
